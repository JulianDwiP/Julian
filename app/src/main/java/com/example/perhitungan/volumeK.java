...
public class volumeK extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_volume_k);
    ...
    public void onClick(View v) {
        ...
        if (!kosong && !invalid) {
            double volume = sisii * sisii * sisii;
